...
round(prop.table(table(gss$relig_affil, gss$educ_attain, gss$race),2),3)*100
```

Results for table not correct. Needs code fix.
...
ordered_factor(gss$educ_attain)
contrasts(gss$educ_attain)
```

This code too needs work.....
