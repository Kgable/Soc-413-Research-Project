...
#Each one of these trials have produced means of zero, but each sd varies greatly. some are greater than one, some are less than one. 
#gss$temp <- standardize(gss$attend)
#gss$temp2 <- standardize(gss$pray)
gss$temp3 <- standardize(gss$god)
```
