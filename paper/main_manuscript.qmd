...
As shown in @fig-Educational_Attainment_by_Sex females and males earning less than a high school degree comprised about the same proportion. Of interest, females, on average, earned more high school and associates degrees than males. The difference is more pronounced in high school degrees than associates degrees with just over thirty percent of females earning high school degrees and just over twenty-five percent of males earning a high school degree. However, males, on average, earned more bachelors and graduate degrees than females. All degree measures are measures of highest degree attained.   
...
```{r}
#| Label: fig-Religiosity_by_Birth_Corhort
...
texreg(list(model1, model2, model3, model4),
       ...
       include.rmse=FALSE)
```
As seen in @fig-Rendering_Models a pattern emerges. Model one considers religiosity of birth cohorts considering the effects of age. Of interest in model one is the shift in effect after the 1950 cohort. From 1900 to 1950, there is a positive association between cohorts and religiosity. The 1950 cohort showed a negative association of a 0.048 decrease in religiosity. This trend continues and increases with each cohort after 1950. Model 2 considers the addition of educational attainment. When the effects for education are controlled it is seen across cohorts the effect of a high school degree shows a 0.042 point decrease in religiosity compared to those with less than a high school degree, on average. This effect is larger for those with some college as it shows a 0.070 point decrease in religiosity compared to those with less than a high school diploma, on average. The effects are even larger for those with bachelors and graduate degrees, on average. 
Model three considers the addition of sex as a variable. A similar pattern emerges in model three with some interesting differences. First, the effects of education on religiosity increase among the categories of high school and some college. Second, when controlling for gender, females tend to experience less of a religiosity decrease than males by .393 points, on average. This indicates females religiosity scales are less negatively associated with increases in education than males. Though it should be noted there is still a drop in the religiosity score. This also makes sense considering the distributions of education and religious attendance. Females comprised the majority of those earning a high school and some college degrees and the majority of those attending religious services once a week or more, on average. 
The final model considers the additional effects on religiosity over time and across genders. Holding all other variables constant, it is seen the effects from educational attainment remain close to those in model three. The youngest cohort, 2000-2009, saw the most statistically significant difference. Among the 2000-2009 birth cohort, females saw a 0.445 decrease in religiosity when compared to males, on average. 
